...
(function() {
    ...
    CanvasInput.prototype = {
      ...
      _overInput: function(x, y) {
        ...
        xRight = x <= self._x + self._extraX + self._width + 14;
        yTop = y >= self._y + self._extraY;
        yBottom = y <= self._y + self._extraY + self._height + 14;
        // ctx.fillRect(self._x + self._extraX, self._y + self._extraY, self._width+14, self._height+14);
